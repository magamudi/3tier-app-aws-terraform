...
# security group for the internal alb, to be accessed only from the nginx reverse proxy server
...
# security group for webservers, to be accessed only from the internal load balancer and bastion instance
